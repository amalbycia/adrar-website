      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-8">
        ...
        <div className="mt-12 pt-10 border-t border-bor-foreground/15 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-8">
          <p className="font-body text-[15px] text-bor-foreground/70 leading-relaxed max-w-xs font-medium">
            Tell us what you need. We&apos;ll respond within one business day with a clear quote.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 shrink-0">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-bor-foreground text-white text-[14px] font-body font-bold uppercase tracking-wide hover:opacity-90 transition-opacity duration-200 shadow-sm"
            >
              Get a Quote
            </Link>
            <Link
        ...
        <p className="mt-8 font-body text-[14px] font-medium text-bor-foreground/50">
          Or call:{' '}
          <a href="tel:0042587553" className="text-bor-foreground hover:text-bor-foreground/70 transition-colors">
            04 2587553
          </a>
        </p>
      </div>
