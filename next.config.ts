        ...
        headers: [
          ...
          { key: 'Strict-Transport-Security', value: 'max-age=63072000; includeSubDomains; preload' },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://cdn.sanity.io https://www.google-analytics.com https://www.googletagmanager.com https://clarity.ms https://*.clarity.ms https://*.sanity.io wss://*.sanity.io",
              "frame-src 'none'",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
